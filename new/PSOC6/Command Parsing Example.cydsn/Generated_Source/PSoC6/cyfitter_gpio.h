...
/* YELLOW */
#define YELLOW_0_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define YELLOW_0_INBUF_ENABLED 0u
#define YELLOW_0_INIT_DRIVESTATE 0u
#define YELLOW_0_INIT_MUXSEL 0u
#define YELLOW_0_INPUT_SYNC 2u
#define YELLOW_0_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define YELLOW_0_NUM 1u
#define YELLOW_0_PORT GPIO_PRT7
#define YELLOW_0_SLEWRATE CY_GPIO_SLEW_FAST
#define YELLOW_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define YELLOW_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define YELLOW_INBUF_ENABLED 0u
#define YELLOW_INIT_DRIVESTATE 0u
#define YELLOW_INIT_MUXSEL 0u
#define YELLOW_INPUT_SYNC 2u
#define YELLOW_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define YELLOW_NUM 1u
#define YELLOW_PORT GPIO_PRT7
#define YELLOW_SLEWRATE CY_GPIO_SLEW_FAST
#define YELLOW_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
