...
module top ;
	...
	wire [0:0] tmpFB_0__BLINKY_net;
	wire [0:0] tmpIO_0__BLINKY_net;
	electrical [0:0] tmpSIOVREF__BLINKY_net;
	...
	cy_mxs40_gpio_v1_0
		...
		BLINKY
		 (.oe({1'b1}),
		  .y({Net_3}),
		  .fb({tmpFB_0__BLINKY_net[0:0]}),
		  .io({tmpIO_0__BLINKY_net[0:0]}),
		  .siovref(tmpSIOVREF__BLINKY_net));
	...
	cy_clock_v1_0
		#(.id("81f46bcf-a5ef-4c88-bb4f-fa0af9b1a590"),
