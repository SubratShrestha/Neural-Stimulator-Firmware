...
void SVCCTL_InitCustomSvc(void) {
	...
	UUID_TYPE_128, &uuid, SizeSerial_Cmd_Char,
	...
	aci_gatt_add_char(CustomContext.CustomStim_Cmd_SvcsHdle,
	UUID_TYPE_128, &uuid, SizeCmd_Fb_Char,
	CHAR_PROP_NOTIFY,
	ATTR_PERMISSION_NONE,
	...
	aci_gatt_add_char(CustomContext.CustomStim_Cmd_SvcsHdle,
	UUID_TYPE_128, &uuid, SizeOta_Req,
	CHAR_PROP_WRITE_WITHOUT_RESP,
	ATTR_PERMISSION_NONE,
	GATT_NOTIFY_ATTRIBUTE_WRITE, 0x10,
	CHAR_VALUE_LEN_CONSTANT, &(CustomContext.CustomOta_ReqHdle));
	...
	UUID_TYPE_128, &uuid, SizeRec_Stream_Char,
	CHAR_PROP_NOTIFY,
	ATTR_PERMISSION_NONE,
	GATT_DONT_NOTIFY_EVENTS, 0x10,
	CHAR_VALUE_LEN_CONSTANT, &(CustomContext.CustomRec_Stream_CharHdle));
...
tBleStatus Custom_STM_App_Update_Char(Custom_STM_Char_Opcode_t CharOpcode,
	...
	case CUSTOM_STM_SERIAL_CMD_CHAR:
		result = aci_gatt_update_char_value(
				...
				CustomContext.CustomSerial_Cmd_CharHdle, 0, /* charValOffset */
	...
	case CUSTOM_STM_CMD_FB_CHAR:
		result = aci_gatt_update_char_value(
				CustomContext.CustomStim_Cmd_SvcsHdle,
				CustomContext.CustomCmd_Fb_CharHdle, 0, /* charValOffset */
	...
	case CUSTOM_STM_OTA_REQ:
		result = aci_gatt_update_char_value(
				CustomContext.CustomStim_Cmd_SvcsHdle,
				CustomContext.CustomOta_ReqHdle, 0, /* charValOffset */
	...
	case CUSTOM_STM_REC_STREAM_CHAR:
		result = aci_gatt_update_char_value(
				...
				CustomContext.CustomRec_Stream_CharHdle, 0, /* charValOffset */
