...
*******************************************************************************/
#define VDAC_PARAM_VrefSource           (0uL)
#define VDAC_PARAM_InitialCode          (0)
#define VDAC_PARAM_OutputBuffer         (0uL)
#define VDAC_PARAM_SampleAndHold        (1uL)
#define VDAC_PARAM_OutputBufferPower    (2uL)
...
#define VDAC_PARAM_VrefVoltage_mV       (3000uL)
