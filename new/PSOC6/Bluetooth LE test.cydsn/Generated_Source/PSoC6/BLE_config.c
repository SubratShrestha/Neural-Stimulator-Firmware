...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x11u, 0x21u, 0x77u, 0x09u,
        0x97u, 0x6Fu, 0x8Au, 0x53u, 0x7Cu, 0x82u, 0x4Fu,
        0x4Du, 0xB3u, 0xB3u, 0xEFu, 0xCFu, 0x11u, 0xE5u,
...
static uint8_t cy_ble_attValues[0x1Bu] = {
    /* Device Name */
    (uint8_t)'C', (uint8_t)'h', (uint8_t)'r', (uint8_t)'i', (uint8_t)'s', (uint8_t)'t', (uint8_t)'i', (uint8_t)'a',
(uint8_t)'n', 
...
static const uint8_t cy_ble_attUuid128[][16u] = {
    /* Device Interface */
    { 0x77u, 0x09u, 0x97u, 0x6Fu, 0x8Au, 0x53u, 0x7Cu, 0x82u, 0x4Fu, 0x4Du, 0xB3u, 0xB3u, 0xEFu, 0xCFu, 0x11u, 0xE5u },
    /* Device Inbound */
    { 0x35u, 0x5Du, 0xA7u, 0xBCu, 0x39u, 0x68u, 0xFBu, 0x89u, 0x1Au, 0x4Fu, 0xC1u, 0xA0u, 0xCAu, 0xEDu, 0x0Eu, 0xADu },
    /* Device Outbound */
    { 0xEBu, 0x36u, 0x97u, 0x5Cu, 0xCEu, 0xA0u, 0x4Au, 0xBAu, 0x13u, 0x4Eu, 0xB3u, 0x16u, 0x3Eu, 0x42u, 0xA8u, 0x3Du },
};
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Cu] = {
    ...
    { 0x0001u, (void *)&cy_ble_attValues[25] }, /* Device Inbound */
    { 0x0010u, (void *)&cy_ble_attUuid128[2] }, /* Device Outbound UUID */
    { 0x0001u, (void *)&cy_ble_attValues[26] }, /* Device Outbound */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x14u] = {
    ...
    { 0x0012u, 0xEDCAu /* Device Inbound                      */, 0x09080100u /* wr    */, 0x0012u, {{0x0001u, (void *)&cy_ble_attValuesLen[9]}} },
    { 0x0013u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0014u, {{0x0010u, (void *)&cy_ble_attValuesLen[10]}} },
    { 0x0014u, 0x423Eu /* Device Outbound                     */, 0x09020001u /* rd    */, 0x0014u, {{0x0001u, (void *)&cy_ble_attValuesLen[11]}} },
};
