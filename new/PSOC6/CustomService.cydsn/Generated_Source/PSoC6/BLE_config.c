...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        ...
        0x75u, 0x72u, 0x6Fu, 0x00u, 0x00u, 0x00u, 0x00u,
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x13u] = {
    ...
    { 0x0000u, (void *)&cy_ble_attValues[24] }, /* RECORDING_STREAM_CHAR */
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x1Bu] = {
    ...
    { 0x0012u, 0xFE41u /* SERIAL_COMMAND_INPUT_CHAR           */, 0x09040100u /* wwr   */, 0x0012u, {{0x0000u, (void *)&cy_ble_attValuesLen[9]}} },
    { 0x0013u, 0x2803u /* Characteristic                      */, 0x00100001u /* ntf   */, 0x0015u, {{0x0010u, (void *)&cy_ble_attValuesLen[10]}} },
    { 0x0014u, 0xFE42u /* COMMAND_FEEDBACK_CHAR               */, 0x09100000u /* ntf   */, 0x0015u, {{0x0000u, (void *)&cy_ble_attValuesLen[11]}} },
    { 0x0015u, 0x2902u /* Client Characteristic Configuration */, 0x030A0001u /* rd,wr */, 0x0015u, {{0x0002u, (void *)&cy_ble_attValuesLen[12]}} },
    { 0x0016u, 0x2803u /* Characteristic                      */, 0x00040001u /* wwr   */, 0x0017u, {{0x0010u, (void *)&cy_ble_attValuesLen[13]}} },
    { 0x0017u, 0xFE11u /* OTA_REQ                             */, 0x09040100u /* wwr   */, 0x0017u, {{0x0003u, (void *)&cy_ble_attValuesLen[14]}} },
    { 0x0018u, 0x2800u /* Primary service                     */, 0x08000001u /*       */, 0x001Bu, {{0x0010u, (void *)&cy_ble_attValuesLen[15]}} },
    { 0x0019u, 0x2803u /* Characteristic                      */, 0x00100001u /* ntf   */, 0x001Bu, {{0x0010u, (void *)&cy_ble_attValuesLen[16]}} },
    { 0x001Au, 0xFE51u /* RECORDING_STREAM_CHAR               */, 0x09100000u /* ntf   */, 0x001Bu, {{0x0000u, (void *)&cy_ble_attValuesLen[17]}} },
    { 0x001Bu, 0x2902u /* Client Characteristic Configuration */, 0x030A0001u /* rd,wr */, 0x001Bu, {{0x0002u, (void *)&cy_ble_attValuesLen[18]}} },
};
