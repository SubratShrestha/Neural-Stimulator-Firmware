...
*
* \funcusage
*  \snippet Kill_Switch_SUT.c usage_Kill_Switch_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Kill_Switch_SUT.c usage_Kill_Switch_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Kill_Switch_SUT.c usage_Kill_Switch_Read  
*******************************************************************************/
...
* preferred Kill_Switch_Read() API because the 
* Kill_Switch_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Kill_Switch_SUT.c usage_Kill_Switch_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Kill_Switch_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Kill_Switch_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Kill_Switch_0_INTR       (First pin in the list)
    *  - Kill_Switch_1_INTR       (Second pin in the list)
    *  - ...
    *  - Kill_Switch_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Kill_Switch_SUT.c usage_Kill_Switch_SetInterruptMode
    *******************************************************************************/
    void Kill_Switch_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Kill_Switch_0_INTR) != 0u) 
		{ 
			 Kill_Switch_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Kill_Switch_SUT.c usage_Kill_Switch_ClearInterrupt
    *******************************************************************************/
