...
module SCB_UART_PDL_v2_0_0 (
	...
	cy_clock_v1_0
		#(.id("54a6ac1c-2dbf-4b9b-8306-71c68373b608/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("54a6ac1c-2dbf-4b9b-8306-71c68373b608/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("54a6ac1c-2dbf-4b9b-8306-71c68373b608/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
module Scan_ADC_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("eab7abfa-9105-4883-8ae4-0f254bc0a087/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
// VDAC12_PDL_v2_0(DacCodeMode=0, DebugEnable=false, DeepSleep=false, DwrExtAfterCustomized=false, DwrRefExternal=0, GainBandwidth=2, InitialCode=0, InitialVoltage_mV=0, OpampIDD=2, OpAmpUsage=1, OutputBuffer=0, OutputBufferPower=2, OutputBufferRange=0, RefBufferRange=0, ReferenceCurrentHigh=true, SampleAndHold=false, ShowClk=false, ShowStrobe=false, ShowTrig=false, UpdateMode=0, VrefSource=0, VrefVoltage=3, VrefVoltage_mV=3000, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC12_PDL_v2_0, CY_CONFIG_TITLE=VDAC_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC_1, CY_INSTANCE_SHORT_NAME=VDAC_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ctdac, CY_PDL_DRIVER_REQ_VERSION=2.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=VDAC_1, )
...
module top ;
	...
	wire [0:0] tmpFB_0__DAC_to_ADC_net;
	wire [0:0] tmpIO_0__DAC_to_ADC_net;
	electrical [0:0] tmpSIOVREF__DAC_to_ADC_net;
	...
	cy_mxs40_gpio_v1_0
		...
		DAC_to_ADC
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__DAC_to_ADC_net[0:0]}),
		  .analog({Net_37}),
		  .io({tmpIO_0__DAC_to_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__DAC_to_ADC_net));
	...
	cy_mxs40_gpio_v1_0
		#(.id("81ff76b5-268f-4460-b27a-cf2375f63c1a"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
