...
module Scan_ADC_v3_10_3 (
	...
	cy_clock_v1_0
		#(.id("39e2b0ff-a065-40ed-ae96-b7224e99f361/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
// VDAC12_PDL_v2_0(DacCodeMode=1, DebugEnable=false, DeepSleep=true, DwrExtAfterCustomized=false, DwrRefExternal=0, GainBandwidth=2, InitialCode=0, InitialVoltage_mV=600, OpampIDD=2, OpAmpUsage=1, OutputBuffer=0, OutputBufferPower=2, OutputBufferRange=1, RefBufferRange=1, ReferenceCurrentHigh=true, SampleAndHold=true, ShowClk=true, ShowStrobe=false, ShowTrig=false, UpdateMode=1, VrefSource=2, VrefVoltage=3, VrefVoltage_mV=1200, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC12_PDL_v2_0, CY_CONFIG_TITLE=VDAC_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC_1, CY_INSTANCE_SHORT_NAME=VDAC_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ctdac, CY_PDL_DRIVER_REQ_VERSION=2.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=VDAC_1, )
module VDAC12_PDL_v2_0_5 (
    ...
    cy_mxs40_opamp_v1_0 REFBUF (
        ...
        .vminus(ref_drive),
        .vplus(Net_10));
    defparam REFBUF.deepsleep_available = 1;
    defparam REFBUF.has_resistor = 0;
    defparam REFBUF.needs_dsab = 1;
	...
	cy_connect_v1_0 cy_analog_virtualmux_2_connect(Net_10, Net_43);
...
// OpAmp_PDL_v1_0(DeepSleepSupport=false, Mode=1, OpampRange=0, OutputCurrent=0, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_PDL_v1_0, CY_CONFIG_TITLE=Opamp_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp_1, CY_INSTANCE_SHORT_NAME=Opamp_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ctb, CY_PDL_DRIVER_REQ_VERSION=1.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Opamp_1, )
...
module top ;
	...
	cy_mxs40_gpio_v1_0
		#(.id("f68dae16-9a7c-419b-ba28-efd6a6c6cbc7"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	wire [0:0] tmpFB_0__StimEN_net;
	wire [0:0] tmpIO_0__StimEN_net;
	electrical [0:0] tmpSIOVREF__StimEN_net;
	...
	cy_mxs40_gpio_v1_0
		...
		StimEN
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__StimEN_net[0:0]}),
		  .io({tmpIO_0__StimEN_net[0:0]}),
		  .siovref(tmpSIOVREF__StimEN_net));
	...
	cy_mxs40_gpio_v1_0
		#(.id("c790e3e8-8b45-4295-ad32-f82416123547"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("87ac4c27-0bea-4020-bca5-16e0926c4b74"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("19dc5c4f-8783-4a04-9b89-28240586fb3f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_clock_v1_0
		#(.id("b62fe8a4-3349-4a7b-8ffc-0bc52d8cf90d"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(0),
		  .period("2000000000"),
		  .is_direct(0),
