...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x04u, 0x09u, 0x68u, 0x65u,
        0x79u, 0x03u, 0x03u, 0x02u, 0x18u, 0x00u, 0x00u,
...
static uint8_t cy_ble_attValues[0x14u] = {
    /* Device Name */
    (uint8_t)'h', (uint8_t)'e', (uint8_t)'y', 
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x08u] = {
    ...
    { 0x0001u, (void *)&cy_ble_attValues[19] }, /* Alert Level */
};
