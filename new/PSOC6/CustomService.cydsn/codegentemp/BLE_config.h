...
#define CY_BLE_GATT_DB_INDEX_COUNT                  (0x001Cu)
 ...
 */
#define CY_BLE_STIMULATION_COMMAND_SERVICE_SERVICE_INDEX   (0x00u) /* Index of STIMULATION_COMMAND_SERVICE service in the cy_ble_customs array */
#define CY_BLE_STIMULATION_COMMAND_SERVICE_SERIAL_COMMAND_INPUT_CHAR_CHAR_INDEX   (0x00u) /* Index of SERIAL_COMMAND_INPUT_CHAR characteristic */
#define CY_BLE_STIMULATION_COMMAND_SERVICE_SERIAL_COMMAND_INPUT_CHAR_SERIAL_COMMAND_INPUT_DESC_INDEX   (0x00u) /* Index of Serial command input descriptor */
#define CY_BLE_STIMULATION_COMMAND_SERVICE_COMMAND_FEEDBACK_CHAR_CHAR_INDEX   (0x01u) /* Index of COMMAND_FEEDBACK_CHAR characteristic */
#define CY_BLE_STIMULATION_COMMAND_SERVICE_COMMAND_FEEDBACK_CHAR_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_STIMULATION_COMMAND_SERVICE_OTA_REQ_CHAR_INDEX   (0x02u) /* Index of OTA_REQ characteristic */

#define CY_BLE_RECORDING_STREAM_SERVICE_SERVICE_INDEX   (0x01u) /* Index of RECORDING_STREAM_SERVICE service in the cy_ble_customs array */
#define CY_BLE_RECORDING_STREAM_SERVICE_RECORDING_STREAM_CHAR_CHAR_INDEX   (0x00u) /* Index of RECORDING_STREAM_CHAR characteristic */
#define CY_BLE_RECORDING_STREAM_SERVICE_RECORDING_STREAM_CHAR_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */


#define CY_BLE_STIMULATION_COMMAND_SERVICE_SERVICE_HANDLE   (0x0010u) /* Handle of STIMULATION_COMMAND_SERVICE service */
#define CY_BLE_STIMULATION_COMMAND_SERVICE_SERIAL_COMMAND_INPUT_CHAR_DECL_HANDLE   (0x0011u) /* Handle of SERIAL_COMMAND_INPUT_CHAR characteristic declaration */
#define CY_BLE_STIMULATION_COMMAND_SERVICE_SERIAL_COMMAND_INPUT_CHAR_CHAR_HANDLE   (0x0012u) /* Handle of SERIAL_COMMAND_INPUT_CHAR characteristic */
#define CY_BLE_STIMULATION_COMMAND_SERVICE_SERIAL_COMMAND_INPUT_CHAR_SERIAL_COMMAND_INPUT_DESC_HANDLE   (0x0013u) /* Handle of Serial command input descriptor */
#define CY_BLE_STIMULATION_COMMAND_SERVICE_COMMAND_FEEDBACK_CHAR_DECL_HANDLE   (0x0014u) /* Handle of COMMAND_FEEDBACK_CHAR characteristic declaration */
#define CY_BLE_STIMULATION_COMMAND_SERVICE_COMMAND_FEEDBACK_CHAR_CHAR_HANDLE   (0x0015u) /* Handle of COMMAND_FEEDBACK_CHAR characteristic */
#define CY_BLE_STIMULATION_COMMAND_SERVICE_COMMAND_FEEDBACK_CHAR_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0016u) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_STIMULATION_COMMAND_SERVICE_OTA_REQ_DECL_HANDLE   (0x0017u) /* Handle of OTA_REQ characteristic declaration */
#define CY_BLE_STIMULATION_COMMAND_SERVICE_OTA_REQ_CHAR_HANDLE   (0x0018u) /* Handle of OTA_REQ characteristic */

#define CY_BLE_RECORDING_STREAM_SERVICE_SERVICE_HANDLE   (0x0019u) /* Handle of RECORDING_STREAM_SERVICE service */
#define CY_BLE_RECORDING_STREAM_SERVICE_RECORDING_STREAM_CHAR_DECL_HANDLE   (0x001Au) /* Handle of RECORDING_STREAM_CHAR characteristic declaration */
#define CY_BLE_RECORDING_STREAM_SERVICE_RECORDING_STREAM_CHAR_CHAR_HANDLE   (0x001Bu) /* Handle of RECORDING_STREAM_CHAR characteristic */
#define CY_BLE_RECORDING_STREAM_SERVICE_RECORDING_STREAM_CHAR_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x001Cu) /* Handle of Client Characteristic Configuration descriptor */
